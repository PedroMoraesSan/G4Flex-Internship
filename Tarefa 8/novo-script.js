function submitQuiz() {
    ...
    if (username && q1 && q2 && q3 && q4 && q5 && q6 && q7 && q8 && q9 && q10 && q11 && q12) {
        ...
        enviarEmail(username, userAnswers.join("\n"));
...
function enviarEmail(username, respostas) {
    // Parâmetros para o envio do email
    let params = {
        user_name: username,
        quiz_results: respostas
    };

    // Configuração do envio via EmailJS
    emailjs.send("service_v206z3r", "template_ivj7ogd", params)
