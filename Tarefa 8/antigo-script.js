...
// Aqui abaixo eu basicamente vou colocar a parte do JS que ficará responsável por enviar o email para mim a partir do momento que o usuário clica em enviar. 
...
function enviarEmail (){
    ...
    emailjs.send("service_v206z3r", "template_ivj7ogd",parms).then(alert("O e-mail foi enviado!"))
}
*/
